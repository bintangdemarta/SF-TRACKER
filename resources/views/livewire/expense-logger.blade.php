<div class="max-w-xl mx-auto space-y-4">
    {{-- PENGELUARAN TERBARU (read-only, tetap di alur scroll) --}}
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
        ...
        @if ($this->recentExpenses->isEmpty())
            <p class="text-gray-500 text-sm py-2">Belum ada pengeluaran tercatat. Ketuk <strong>Keluar</strong> di bar bawah.</p>
        @else
    ...
    {{-- CATAT PENGELUARAN — bottom sheet --}}
    <div x-show="$store.sheet.isOpen('expense')" x-cloak
        ...
        x-on:expense-logged-clean.window="$store.sheet.close()"
        ...
        role="dialog" aria-modal="true" aria-labelledby="expense-sheet-title">
        <div class="sticky top-0 bg-white flex items-center justify-between px-6 pt-4 pb-2 border-b border-gray-100">
            <h3 id="expense-sheet-title" class="text-lg font-semibold text-gray-900">Catat Pengeluaran</h3>
